...
EXECUTABLE_NAME=aws-springboot-webservice
...
nohup java -Dspring.config.location=classpath:/application.properties,/home/ec2-user/app/application-oauth.properties \
